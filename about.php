...
<body>
    ...
    <div class="boxed_wrapper ltr">
        ...
        <!-- feature-style-two -->
        <section class="feature-style-two about-page pb_150 centred">
            <div class="auto-container">
                <div class="sec-title mb_50">
                    <span class="sub-title">Features Services</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                        <div class="feature-block-two wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h3><a href="service-details.html">Dumpster Rental</a></h3>
                                <p>Lorem ipsum dolor sit amet consectetur elit.</p>
                                <div class="link">
                                    <a href="service-details.html"><i class="icon-7"></i></a>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                        <div class="feature-block-two wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h3><a href="service-details.html">Waste Collection</a></h3>
                                <p>Lorem ipsum dolor sit amet consectetur elit.</p>
                                <div class="link">
                                    <a href="service-details.html"><i class="icon-7"></i></a>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                        <div class="feature-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h3><a href="service-details.html">Recycling Service</a></h3>
                                <p>Lorem ipsum dolor sit amet consectetur elit.</p>
                                <div class="link">
                                    <a href="service-details.html"><i class="icon-7"></i></a>
                                </div>
                ...
                <div class="more-btn mt_60">
                    <a href="service.html" class="theme-btn"><span>More Services</span></a>
                </div>
            </div>
        </section>
        ...
        <section class="cta-style-two">
            <div class="pattern-layer">
                ...
                <div class="pattern-5 float-bob-y" style="background-image: url(assets/images/shape/shape-24.png);"></div>
            </div>
            <div class="auto-container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image-box">
                            <div class="image-shape" style="background-image: url(assets/images/shape/shape-22.png);"></div>
                            <figure class="image"><img src="assets/images/resource/truck-1.png" alt=""></figure>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content-box ml_30">
                            <h2>Become our customer & get special service</h2>
                            <div class="btn-box">
                                <a href="index-2.html" class="theme-btn btn-one"><span>Request A Pickup</span></a>
                                <a href="index-2.html" class="theme-btn btn-two"><span>Request A Pickup</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12 col-sm-12 title-column">
                            <div class="sec-title light pr_90">
                                ...
                                <h2>We collect, <br />recycle & disposal <br />all materials</h2>
                            </div>
                        </div>
        ...
        <!-- team-section -->
        <section class="team-section alternat-2 sec-pad centred">
            <div class="auto-container">
                <div class="sec-title mb_50">
                    <span class="sub-title">Our Experts</span>
                    <h2>Our experts staff & <br />Members</h2>
                </div>
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one mb_25 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="team-details.html"><img src="assets/images/team/team-11.jpg" alt=""></a></figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one mb_25 wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="team-details.html"><img src="assets/images/team/team-12.jpg" alt=""></a></figure>
                                <div class="lower-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one mb_25 wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="team-details.html"><img src="assets/images/team/team-13.jpg" alt=""></a></figure>
                                <div class="lower-content">
