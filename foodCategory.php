...
<title>FoodSave -  Food Category | Profile</title>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 form-column">
                        <div class="form-inner">
                            <form method="post" action="./functions/foodCategory.php" id="contact-form" class="default-form"> 
                                <div class="row clearfix">
                                    
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        <input type="text" name="title"  placeholder="Category title/name" required="">
                                    </div>
                                   
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <textarea  name="description"  required="" placeholder="Describe This Category"></textarea>
                                    </div>
