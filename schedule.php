    ...
    <div class="boxed_wrapper ltr">
        ...
        <section class="cta-style-three p_relative pt_150 pb_150" id="schedule">
            ...
            <div class="auto-container">
                <div class="inner-box">
                    <h2> Make a <span>Schedule</span> </h2>
                    <hr>
                    <div class="form-inner">
                            <form method="post" action="./functions/schedule.php" id="contact-form" class="default-form" enctype="multipart/form-data"> 
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <label for="expdate">Selected Date</label>
