...
<title>FoodSave - Home|Review </title>
    ...
    <div class="boxed_wrapper ltr">
        ...
        <section class="cta-style-three p_relative pt_150 pb_150" id="schedule">
            ...
            <div class="auto-container">
                <div class="inner-box">
                    <h2> Make a  <span>Review About</span> </h2>
                    <hr>
                    <div class="form-inner">
                            <form method="post" action="./functions/reviewCreate.php" id="contact-form" class="default-form" enctype="multipart/form-data"> 
